...
public sealed class SnakePaperUi(IContext context, IKeyboardInput keyboardInput) : IPaperUi
{
    ...
    public void Draw(PaperGui gui, FontFile font)
    {
        ...
        using (gui.Box("SnakeHud")
                   ...
                   .Top(12)
                   .Padding(8)
                   .BackgroundColor(new Prowl.Vector.Color(0, 0, 0, 0.45f))
                   .Rounded(6)
                   .Enter())
        {
            gui.Box("ScoreLabel")
        ...
        using (gui.Box("PauseOverlay")
                   .Width(gui.Stretch())
                   .Height(gui.Stretch())
                   .BackgroundColor(new Prowl.Vector.Color(0, 0, 0, 0.55f))
                   .OnClick(_ => { })
                   .Enter())
        {
            using (gui.Column("PauseMenu")
                       ...
                       .Padding(16)
                       .BackgroundColor(new Prowl.Vector.Color(30 / 255f, 30 / 255f, 30 / 255f, 1f))
                       .Rounded(10)
                       .Enter())
            {
                gui.Box("PauseTitle")
                ...
                gui.Box("ResumeButton")
                    .Height(40)
                    .BackgroundColor(new Prowl.Vector.Color(46 / 255f, 125 / 255f, 50 / 255f, 1f))
                    .Rounded(6)
                    .OnClick(_ =>
                    {
                        if (game.GameOver)
