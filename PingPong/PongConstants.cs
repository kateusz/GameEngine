...
internal static class PongConstants
{
    ...
    public const float AiMoveSpeed = 4.5f;
    ...
    public static readonly Vector2 PaddleColliderHalfExtents = new(0.5f, 0.5f);
    public static readonly Vector3 BallScale = new(0.5f, 0.5f, 1.0f);
    public static readonly Vector2 BallColliderHalfExtents = new(0.5f, 0.5f);
}
