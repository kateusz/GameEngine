...
public class Context
{
    ...
    /// Uses value tuples and iterator pattern to eliminate heap allocations.
    /// </summary>
    ...
    /// - Zero heap allocations when used with foreach loops
    /// - Uses value tuples (Entity, TComponent) instead of reference-type Tuple
    /// - Iterates directly over entities without intermediate List allocation
