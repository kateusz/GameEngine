...
| `cameras` | camera | `Engine/Scene/Cameras/`, `Engine/Scene/SceneCamera.cs`, `Engine/Scene/Systems/CameraQueries.cs` | — | `docs/architecture/rendering-pipeline.md` (camera sections only) | `docs/guide/concepts/cameras-and-rendering.md` | — | Features → Rendering (camera bullet); Key Systems → Camera System | `Camera System`, `CameraComponent` |
