...
public class SceneHierarchyPanel
{
    ...
    public void DrawVec3Control(string label, ref Vector3 values, float resetValue = 0.0f)
    {
        ...
        float sectionWidth = columnWidth / 3.0f;
    ...
    public void DrawVec2Control(string label, ref Vector2 values, float resetValue = 0.0f)
    {
