...
public class CapsuleCollider3DComponentEditor(UIPropertyRenderer propertyRenderer, IEditorHistory history)
    : ComponentEditor<CapsuleCollider3DComponent>(history)
{
    protected override string DisplayName => "Capsule Collider 3D";

    protected override void DrawContent(CapsuleCollider3DComponent component, Entity entity)
    {
        ...
        propertyRenderer.DrawPropertyField("Length", component.Length,
            newValue => component.Length = (float)newValue);
