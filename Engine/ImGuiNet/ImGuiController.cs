...
void main()
{
    ...
    private void UpdateImGuiInput()
    {
        ...
        foreach (Keys key in Enum.GetValues(typeof(Keys)))
        {
            ...
            io.KeysDown[(int)key] = keyboardState.IsKeyPressed(keyCode);
        }
        ...
        io.KeyCtrl = keyboardState.IsKeyPressed((KeyCodes)Keys.LeftControl) ||
                     keyboardState.IsKeyPressed((KeyCodes)Keys.RightControl);
        io.KeyAlt = keyboardState.IsKeyPressed((KeyCodes)Keys.LeftAlt) ||
                    keyboardState.IsKeyPressed((KeyCodes)Keys.RightAlt);
        io.KeySuper = keyboardState.IsKeyPressed((KeyCodes)Keys.LeftSuper) ||
                      keyboardState.IsKeyPressed((KeyCodes)Keys.RightSuper);
        io.KeyShift = keyboardState.IsKeyPressed((KeyCodes)Keys.LeftShift) ||
                      keyboardState.IsKeyPressed((KeyCodes)Keys.RightShift);
    }
    ...
    private void RenderImDrawData(ImDrawDataPtr drawData)
    {
        ...
        var scl = io.DisplayFramebufferScale;
