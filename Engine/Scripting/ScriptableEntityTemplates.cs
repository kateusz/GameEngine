...
public static class ScriptableEntityTemplates
{
    public static string Generate(string className) => $$"""
        ...
        {
            public {{className}}(IComponentAccessor componentAccessor, IAudio audio, IAudioPlayback audioPlayback, IPhysicsQueries physicsQueries, IEntityHierarchy hierarchy) : base(componentAccessor, audio, audioPlayback, physicsQueries, hierarchy) { }
